...
urlpatterns = [
    ...
    path('intervention/wr/challenge-10/', views.tr_challenge_11, name='wr_challenge_10'),
    ...
    path('intervention/dom/challenge-15/', views.dom_challenge_16, name='dom_challenge_15'),
